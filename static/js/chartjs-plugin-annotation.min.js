...
!function e(t, n, i) {
    ...
    2: [function (e, t, n) {
        t.exports = function (t) {
            ...
            var o = t.helpers, a = e("./helpers.js")(t), r = e("./events.js")(t), l = t.Annotation.types;
            return {
                    ...
                    if (t.supported) {
                        ...
                        t.options.annotations.forEach(function (i) {
                            ...
                            if (!t.elements[o] && l[i.type]) {
                                var r = l[i.type], s = new r({id: o, options: i, chartInstance: e});
    ...
    4: [function (e, t, n) {
        t.exports = function (t) {
            ...
            function i(e) {
                var t = this.annotation, i = a.elements(this), r = o.getRelativePosition(e, this.chart),
                    l = a.getNearestItems(i, r), s = n(t.options.events), c = t.options.dblClickSpeed, u = [],
                    f = a.getEventHandlerName(e.type), d = (l || {}).options;
                if ("mousemove" === e.type && (l && !l.hovering ? ["mouseenter", "mouseover"].forEach(function (t) {
                    var n = a.getEventHandlerName(t), i = a.createMouseEvent(t, e);
                    ...
                    if (t.hovering) {
                        ...
                        ["mouseout", "mouseleave"].forEach(function (i) {
                            var o = a.getEventHandlerName(i), r = a.createMouseEvent(i, e);
        ...
        t.exports = function (e) {
            ...
            function d(e, t) {
                ...
                return e.filter(function (e) {
                    ...
                    var o = i.getCenterPoint(), a = h.distanceBetweenPoints(t, o);
    ...
    7: [function (e, t, n) {
        t.exports = function (t) {
            var n = e("../helpers.js")(t), i = t.Annotation.Element.extend({
                setDataLimits: function () {
                    var e = this._model, t = this.options, i = this.chartInstance, o = i.scales[t.xScaleID],
                        a = i.scales[t.yScaleID], r = i.chartArea;
                    if (e.ranges = {}, r) {
                        var l = 0, s = 0;
    ...
    8: [function (e, t, n) {
        t.exports = function (t) {
            ...
            var o = t.helpers, a = e("../helpers.js")(t), r = "horizontal", l = "vertical",
